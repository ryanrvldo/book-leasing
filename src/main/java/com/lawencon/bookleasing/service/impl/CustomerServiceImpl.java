...
public class CustomerServiceImpl implements CustomerService {
  ...
  @Autowired
  public CustomerServiceImpl(@Qualifier("customer-hql") CustomerDao dao, ProfileService profileService) {
	this.dao = dao;
  ...
  public List<Customer> getAll() throws Exception {
	...
	if (customerList.isEmpty()) throw new NoResultException("Customer list is empty.");
	return customerList;
  }
